...
?>
	<style type="text/css">
		/* Admin Bar */
			#wpadminbar { color: #555; background: #eee; border-bottom: 1px solid #ddd; text-align: center; }
			#wpadminbar #wp-toolbar { max-width: 1440px; margin-left: auto; margin-right: auto; }
			#wpadminbar #wp-toolbar a.ab-item, #wpadminbar .quicklinks li#wp-admin-bar-bp-notifications > a { padding: 0 5px 0 5px; }
